...
////////////////////////////////////////////////////////////////////
/* acts as the 'server' for the topic store. 'accepts' initial connections from
	pubs/subs and passes their connections to topic store process to interact
...
int main(int argc, char * argv[]){
    ...
    // waitfor all child processes to complete for termination of server
    if (pid > 0) {
        int status = 0;
        pid_t childPid;
